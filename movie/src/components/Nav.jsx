  ...
  return (
    <>
      ...
      >
          ...
          {Navdata.map((data) => (
            <Link key={data.id} to={data.link}>
              <li
                ...
                } p-2 my-5 hover:bg-blue-500/20 rounded-[5px] border-2 hover:border-blue-600`}
                onClick={() => setActivemobile(!activemobile)}
              >
                {data.Name}
              </li>
        ...
        <div className=" w-full p-5 md:p-2 text-white">
          {user ? (
            <>
              <div className="w-full bg-gray-900 px-5  py-2 md:py-0 rounded-xl flex items-center font-semibold border-2 border-blue-100/10">
                <img
              ...
              <div
                className="cursor-pointer bg-red-600 hover:bg-red-800 flex justify-center items-center p-2 rounded-xl mt-2"
            ...
            <>
              <Link
                to="/login"
                className=" bg-blue-600 hover:bg-blue-800 px-2 py-2 rounded-xl flex items-center justify-center font-semibold border-2 border-blue-100/10 cursor-pointer"
                onClick={() => setActivemobile(!activemobile)}
              >
        ...
        <footer className="text-center md:text-left absolute bottom-0">
